...
근래 자바 개발에 필요성을 느껴 스터디를 하고있는 것을 알고 있던 주변 개발자들 추천으로 해당 스터디를 진행하게 되었습니다.

놀라웠던 점은 동시에 여러분들이 해당 youtube 영상 링크를 보내주시며 같이해보자고 권유해주셨고, 인생 헛산게 아니구나 라는 생각을 하게되었습니다 :) 
